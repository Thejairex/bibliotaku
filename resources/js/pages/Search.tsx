    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-12 animate-fade-in">
                {/* Hero Search Section */}
                <div className="relative overflow-hidden rounded-[2.5rem] bg-surface-container border border-outline-variant/5">
                    <div className="relative z-10 px-8 py-12 md:px-14 md:py-16">
                        <div className="max-w-3xl">
                            ...
                            <p className="text-on-surface-variant text-lg md:text-xl leading-relaxed mb-10 max-w-2xl font-medium">
                                {mode === 'local' 
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-4">
                        <div>
                            <h3 className="text-2xl font-headline font-black text-on-surface tracking-tight">
                                Search Results
                                {query && <span className="text-on-surface-variant font-medium text-base ml-3 italic">"{query}"</span>}
                            </h3>
                        </div>
